...
public class MultiTreeNode extends SingleTreeNode {
    ...
    MCTSEAHPlayer mctsPlayer;

    public MultiTreeNode(MCTSEAHPlayer player, AbstractGameState state, Random rnd) {
        ...
        if (params.information == MCTSEAHEnums.Information.Closed_Loop)
           params.information = MCTSEAHEnums.Information.Open_Loop;
