...
public class RHEAEAIndividual implements Comparable<RHEAEAIndividual> {
    ...
    RHEAEAIndividual(int L, double discountFactor, AbstractForwardModel fm, AbstractGameState gs,
    ...
    // Copy constructor
    RHEAEAIndividual(RHEAEAIndividual I) {
...
//        this.value = gs.getScore(playerID);
    ...
    @Override
    public int compareTo(RHEAEAIndividual b) {
        RHEAEAIndividual a = this;
        return Double.compare(b.value, a.value);
    }

    @Override
    public boolean equals(Object o) {
        if (!(o instanceof RHEAEAIndividual)) return false;

        RHEAEAIndividual a = this;
        RHEAEAIndividual b = (RHEAEAIndividual) o;
